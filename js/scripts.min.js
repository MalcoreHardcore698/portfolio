...
$(function(){$(".hamburger").click(function(){$(this).addClass("is-active"),$(".top-line .nav-menu .menu").css({height:$(window).height()}),$("body").hasClass("shift-page")||($("body").addClass("shift-page"),$(".wb").addClass("blackout"),$("body").animate({right:240})),$(".wb").click(function(){$(this).hasClass("blackout")&&($(".wb").removeClass("blackout"),$("body").removeClass("shift-page"),$(".hamburger").removeClass("is-active"),$("body").animate({right:0}))})});$(window).scroll(function(){$(window).scrollTop();$(window).width()>769&&($(window).scrollTop()>80?$(".top-line").addClass("scrollActive"):$(".top-line").removeClass("scrollActive"))}),$(".portfolio .owl-carousel").owlCarousel({items:1,nav:!0,navText:!1,responsive:{721:{items:2,nav:!0}}}),$(".s-reviews .owl-wrap .owl-carousel").owlCarousel({items:1,nav:!0,navText:!1,dot:!0,stagePadding:50,margin:10});var s=$(".s-reviews .owl-wrap .owl-dots").width();$(".s-reviews .owl-wrap .owl-dots").height(),$(".s-reviews").height(),$(".s-reviews .owl-wrap .owl-item").height();$(".s-reviews .owl-wrap .owl-dots").css("margin-left","-"+(s+15)/2+"px")});